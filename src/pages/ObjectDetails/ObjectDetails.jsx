...
import {routerParamsDecorator} from "@utils"
import "./ObjectDetails.sass"

/**
 * @description City Details Page shows name, country, notes and weather forecest of city
 * @param {{city: string}} IObjectDetailsProps
 */

export const ObjectDetails = routerParamsDecorator(({ city }) => {
